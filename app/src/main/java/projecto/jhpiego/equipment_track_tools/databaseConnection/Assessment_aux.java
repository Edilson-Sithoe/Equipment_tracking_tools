...
public class Assessment_aux extends SQLiteOpenHelper {

    SQLiteDatabase db;
    private static final String TABLE_ASSESSMENT = "tabela_geral";
    private Context context;

    public Assessment_aux(Context context) {
        super(context, Database_connection.DATABASE_NAME, null, Database_connection.DATABASE_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
       /* Log.w("funcionando", "funcionando");
        String table2 = "CREATE TABLE " + TABLE_ASSESSMENT + " (" +
