...
public class FormGeneratorFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  getSupportActionBar().hide();
        ...
        btnNExt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(capacity) || TextUtils.isEmpty(frequ_pm) || TextUtils.isEmpty(name)) {
                    ...
                    Intent i = new Intent(FormGeneratorFour.this, FormStabilizer.class);
                    startActivity(i);
                }
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(FormGeneratorFour.this, FormGeneratorThree.class);
                startActivity(i);
            }
        });
    ...
    public void onRadioButtonClicked_gfour(View view) {
    ...
    public void onRadioButtonClicked_two_gfour(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_three_gfour(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_four_gfour(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_five_gfour(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_six_gfour(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_seven_gfour(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_eight_gfour(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_nine_gfour(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_ten_gfour(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_eleven_gfour(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_twelve_gfour(View view) {
        boolean checked = ((RadioButton) view).isChecked();
