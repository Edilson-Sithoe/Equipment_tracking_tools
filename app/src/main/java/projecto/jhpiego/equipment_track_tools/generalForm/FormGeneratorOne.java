...
public class FormGeneratorOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_generator_one);
     ...
     //   getSupportActionBar().hide();
        ...
        btnNExt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(capacity) || TextUtils.isEmpty(frequ_pm) || TextUtils.isEmpty(name)) {
                    ...
                    Intent i = new Intent(FormGeneratorOne.this, FormGeneratorTwo.class);
                    startActivity(i);
                }
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(FormGeneratorOne.this, FormElectricity.class);
                startActivity(i);
            }
        });
    ...
    public void onRadioButtonClicked_go(View view) {
    ...
    public void onRadioButtonClicked_two_go(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_three_go(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_four_go(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_five_go(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_six_go(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_seven_go(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_eight_go(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_nine_go(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_ten_go(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_eleven_go(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_twelve_go(View view) {
        boolean checked = ((RadioButton) view).isChecked();
