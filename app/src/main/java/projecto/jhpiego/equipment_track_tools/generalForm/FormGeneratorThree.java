...
public class FormGeneratorThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().hide();
        ...
        btnNExt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(capacity) || TextUtils.isEmpty(frequ_pm) || TextUtils.isEmpty(name)) {
                    ...
                    Assessment.assessment_model.setTxtComentThree(txtComent.getText().toString());

                    Intent i = new Intent(FormGeneratorThree.this, FormGeneratorFour.class);
                    startActivity(i);
                }
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(FormGeneratorThree.this, FormGeneratorTwo.class);
                startActivity(i);
            }
        });
    ...
    public void onRadioButtonClicked_gthree(View view) {
    ...
    public void onRadioButtonClicked_two_gthree(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_three_gthree(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_four_gthree(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_five_gthree(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_six_gthree(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_seven_gthree(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_eight_gthree(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_nine_gthree(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_ten_gthree(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_eleven_gthree(View view) {
        boolean checked = ((RadioButton) view).isChecked();
    ...
    public void onRadioButtonClicked_twelve_gthree(View view) {
        boolean checked = ((RadioButton) view).isChecked();
